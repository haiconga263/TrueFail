...
export class GeoService {
  ...
  private urlWard: string = '/api/Geo/get/Ward';
  ...
  getWard(wardId: number): Observable<ResultModel<Ward>> {
    return this.http.get<ResultModel<Ward>>(`${AppConsts.remoteServiceBaseUrl}${this.urlWard}?wardId=${wardId}`, this.authenticSvc.getHttpHeader());
  }
