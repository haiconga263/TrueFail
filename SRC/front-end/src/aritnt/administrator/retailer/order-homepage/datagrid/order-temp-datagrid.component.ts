...
import { RetailerOrderTempService, RetailerOrderTemp } from '../retailer-order-temp.service';
import { ResultCode } from 'src/core/constant/AppEnums';
import { FuncHelper } from 'src/core/helpers/function-helper';

@Component({
  selector: 'order',
  templateUrl: './order-temp-datagrid.component.html',
  styleUrls: ['./order-temp-datagrid.component.css']
})
export class OrderTempComponent extends AppBaseComponent {
  private ordersTemp: RetailerOrderTemp[] = [];
  //selectedRows: number[];
  ...
  constructor(
    injector: Injector,
    private orderTempSvc: RetailerOrderTempService,
  ...
  loadDatasource(callback: () => void = null) {
    this.orderTempSvc.gets().subscribe((result) => {
     if (result.result == ResultCode.Success) {

       this.ordersTemp = result.data;
