...
{
    public class GTIN8Service : BaseGTINTypeService, IGTINTypeService
    {
        public GTIN8Service(IGTINQueries gTINQueries, IGTINRepository gTINRepository, ISessionBufferService sessionBufferService) 
            : base(gTINQueries, gTINRepository, sessionBufferService)
        {
        }

        public override int MaxLengthNumeric => 7;
