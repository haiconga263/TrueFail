...
{
    public class GetAllProcessCommand : BaseCommand<IEnumerable<ProcessInformation>>
    {
        public GetAllProcessCommand()
        {
        }
    }

    public class GetAllProcessCommandHandler : BaseCommandHandler<GetAllProcessCommand, IEnumerable<ProcessInformation>>
    {
        ...
        public GetAllProcessCommandHandler(IProcessRepository processRepository, IProcessQueries processQueries,
        ...
        public override async Task<IEnumerable<ProcessInformation>> HandleCommand(GetAllProcessCommand request, CancellationToken cancellationToken)
        {
            ...
            var lst = (await processQueries.GetAllAsync(company?.Id)).ToList();
